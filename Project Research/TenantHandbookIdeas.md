...
- Showerhead: **Utilities**: It is the tenant's responsibility to set up utilities for the property if this is not done so already. UniHomes offers but of course you can choose a different utilities provider.
- Oven: **Repair of Items**: 
- Lightbulb: **Property Maintenance**:
- Cupboard next to the stairs: **Meter Readings** 
